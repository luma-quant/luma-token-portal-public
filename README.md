...
- public repository: `https://github.com/wotanIII/luma-token-portal-public`, creation and public visibility verified;
...
The public CI runs full-history Gitleaks through a checksum-pinned CLI that does not call the GitHub pull-request API. All third-party actions are pinned to full commit SHAs. On published baseline `64c73b23aa0e6039653079d2b321d4025c0758d9`, the verification and CodeQL jobs completed successfully in [run 31691842203](https://github.com/wotanIII/luma-token-portal-public/actions/runs/31691842203), and the point-in-time code-scanning query recorded zero open alerts. Repository permissions remain read-only. These results are bound to that baseline, not self-referentially to this later status-alignment change.
...
The public Trust Layer index is `https://github.com/wotanIII/luma-trust-layer-v1`
and the Engine Evidence repository is
`https://github.com/wotanIII/luma-engine-evidence-public`. The private
